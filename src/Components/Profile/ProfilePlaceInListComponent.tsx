...
const ProfilePlaceInListComponent = (props) => {
  const {item} = props
  ...
  return (
    <TouchableOpacity onPress={() => {navigation.navigate('ProfileSinglePlace', {place: item})}} style={styles.container}>
...
export default ProfilePlaceInListComponent
