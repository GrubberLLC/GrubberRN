...
const ActivityListPlaceTileComponent = (props) => {
  const {item} = props
  ...
  return (
    <TouchableOpacity onPress={() => {navigation.navigate('ActivityUserListScreen', {list: item})}} style={styles.container}>
...
export default ActivityListPlaceTileComponent
